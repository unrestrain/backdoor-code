...
def train_cifar10_vgg19_models(path='/data/yz/models/clean_models/cifar10/vgg19',device='cuda:0'):
    image_size = 32
    train_transforms = transforms.Compose([
    transforms.Resize((image_size,image_size)),
    transforms.RandomCrop(image_size, padding=1),
    ...
    trainset = torchvision.datasets.CIFAR10('/data/yz/dataset/cifar10',download=True,train=True,transform=train_transforms)
    testset = torchvision.datasets.CIFAR10('/data/yz/dataset/cifar10',download=True,train=False,transform=test_transforms)
    ...
    for i in range(1,501):
        ...
        model = train(trainset,testset,model,epoch=epoch,device=device,model_type='vgg19', dataset_type='cifar10',save_path=save_path,lr=0.0001,image_size=(image_size,image_size))
